...
const STRINGS = {
  en: {
    ...
    rowWaterQuietDesc: "Skip reminders during this window (24h, HH:MM). Can cross midnight.",
    rowWaterSnooze: "Snooze length",
    rowWaterSnoozeDesc: "Minutes to defer when you tap \"+N min\" or ignore a bubble.",
    rowWaterTestNow: "Test now",
    rowWaterTestNowDesc: "Manually trigger a reminder to preview placement and style.",
    rowTranslatorEnabled: "Translator popup",
    rowTranslatorEnabledDesc: "Register a global shortcut that opens a quick translate window at the cursor.",
    rowTranslatorShortcut: "Shortcut",
    rowTranslatorShortcutDesc: "Electron accelerator (e.g. CmdOrCtrl+Shift+T). Blank disables the shortcut.",
    actionWaterTriggerNow: "Trigger",
    agentsTitle: "Agents",
  ...
  zh: {
    ...
    sectionStartup: "启动",
    sectionBubbles: "气泡",
    sectionHydrationTranslator: "喝水提醒 & 翻译",
    rowWaterEnabled: "喝水提醒",
    rowWaterEnabledDesc: "外星人会定时弹一个喝水气泡。仅在 Alien 主题下生效。",
    rowWaterInterval: "提醒间隔",
    rowWaterIntervalDesc: "相邻两次提醒的分钟数（1–480）。",
    rowWaterQuiet: "静默时段",
    rowWaterQuietDesc: "此时段内不提醒（HH:MM，24小时制，可跨零点）。",
    rowWaterSnooze: "稍后再提",
    rowWaterSnoozeDesc: "点 “+N 分钟” 或忽略气泡后，推迟的分钟数。",
    rowWaterTestNow: "立即测试",
    rowWaterTestNowDesc: "手动触发一次提醒，用于预览气泡位置和样式。",
    rowTranslatorEnabled: "翻译弹窗",
    rowTranslatorEnabledDesc: "注册全局快捷键，在光标位置弹出翻译小窗。",
    rowTranslatorShortcut: "快捷键",
    rowTranslatorShortcutDesc: "Electron 快捷键格式，例如 CmdOrCtrl+Shift+T。清空表示禁用。",
    actionWaterTriggerNow: "触发",
  ...
  es: {
    ...
    sidebarTheme: "Tema",
    sidebarAnimMap: "Mapa de animaciones",
    sidebarAnimOverrides: "Overrides de animación",
    sidebarShortcuts: "Atajos",
    sidebarAbout: "Acerca de",
    shortcutsTitle: "Atajos",
    shortcutsSubtitle: "Configura atajos globales para mostrar/ocultar la mascota y para acciones de permisos. Déjalos vacíos para desactivarlos.",
    ...
    shortcutErrorReserved: "Combinación reservada. Usa otra.",
    shortcutErrorInvalid: "Combinación de teclas no admitida.",
    shortcutErrorNeedsModifier: "El atajo necesita al menos una tecla modificadora.",
    ...
    sidebarSoon: "Próximamente",
    sectionAppearance: "Apariencia",
    sectionStartup: "Inicio",
    sectionBubbles: "Burbujas",
    sectionHydrationTranslator: "Hidratación y traductor",
    rowWaterEnabled: "Recordatorios de agua",
    rowWaterEnabledDesc: "El alien saca una burbuja de hidratación según el horario. Solo en el tema Alien.",
    rowWaterInterval: "Intervalo",
    rowWaterIntervalDesc: "Minutos entre recordatorios (1–480).",
    rowWaterQuiet: "Horas silenciosas",
    rowWaterQuietDesc: "Saltar recordatorios en esta franja (24h, HH:MM). Puede cruzar medianoche.",
    rowWaterSnooze: "Posponer",
    rowWaterSnoozeDesc: "Minutos a diferir al pulsar \"+N min\" o ignorar una burbuja.",
    rowWaterTestNow: "Probar ahora",
    rowWaterTestNowDesc: "Dispara un recordatorio manualmente para ver ubicación y estilo.",
    rowTranslatorEnabled: "Ventana de traducción",
    rowTranslatorEnabledDesc: "Registra un atajo global que abre una ventana de traducción junto al cursor.",
    rowTranslatorShortcut: "Atajo",
    rowTranslatorShortcutDesc: "Acelerador Electron (p. ej. CmdOrCtrl+Shift+T). Vacío lo desactiva.",
    actionWaterTriggerNow: "Disparar",
    agentsTitle: "Agentes",
    agentsSubtitle: "Activa o desactiva el seguimiento por agente. Los agentes desactivados detienen el monitor de logs y descartan los eventos hook en el límite HTTP, por lo que no mueven la mascota, no muestran burbujas de permiso ni mantienen sesiones.",
    agentsEmpty: "No hay agentes registrados.",
    eventSourceHook: "Hook",
    eventSourceLogPoll: "Sondeo de log",
    eventSourcePlugin: "Plugin",
    ...
    rowShowSessionId: "Mostrar ID de sesión",
    rowShowSessionIdDesc: "Añade el ID de sesión corto a las cabeceras de las burbujas y al menú de Sesiones.",
    rowAllowEdgePinning: "Permitir anclar a los bordes de la pantalla",
    rowAllowEdgePinningDesc: "Cuando se ancla a un borde, los adornos superiores/inferiores (destellos, edificios, burbujas, …) pueden quedar recortados.",
    rowSize: "Tamaño",
    ...
    themeCapabilityTracked: "Idle con seguimiento",
    themeCapabilityAnimated: "Idle animado",
    themeCapabilityStatic: "Tema estático",
    themeCapabilityMini: "Mini",
    themeCapabilityDirectSleep: "Sueño directo",
    ...
    animMapAttentionDesc: "Animación alegre de rebote que se reproduce cuando un agente termina su turno. (Stop / PostCompact)",
    animMapErrorLabel: "Destello de error",
    animMapErrorDesc: "Animación de sacudida cuando falla una llamada de herramienta.",
    animMapSweepingLabel: "Limpieza de contexto",
    animMapSweepingDesc: "Animación de barrer durante PreCompact / limpieza de contexto.",
    animMapNotificationLabel: "Notificación",
    animMapNotificationDesc: "Animación de campanilla en peticiones de permiso o de entrada.",
    animMapCarryingLabel: "Transporte de worktree",
    animMapCarryingDesc: "Animación de transporte cuando se crea un worktree.",
    toastAnimMapResetOk: "Overrides de animación restablecidos.",
    animOverridesTitle: "Overrides de animación",
    animOverridesSubtitle: "Cambia los archivos por tarjeta del tema actual y ajusta los tiempos de fundido y retorno.",
    animOverridesCurrentTheme: "Tema actual",
    animOverridesOpenThemeTab: "Abrir pestaña de Tema",
    animOverridesOpenAssets: "Abrir carpeta assets",
    animOverridesResetAll: "Restablecer todo a los valores por defecto",
    animOverridesExport: "Exportar…",
    animOverridesImport: "Importar…",
    toastAnimOverridesExportOk: (count, path) => `Exportadas ${count} overrides de tema → ${path}`,
    toastAnimOverridesImportOk: (count) => `Importadas ${count} overrides de tema.`,
    toastAnimOverridesExportEmpty: "No hay overrides para exportar.",
    toastAnimOverridesExportFailed: (message) => `Exportación fallida: ${message}`,
    toastAnimOverridesImportFailed: (message) => `Importación fallida: ${message}`,
    animOverridesChangeFile: "Cambiar archivo",
    animOverridesPreview: "Vista previa una vez",
    animOverridesReset: "Restablecer ranura",
    animOverridesFade: "Fundido",
    animOverridesFadeIn: "Entrada",
    animOverridesFadeOut: "Salida",
    animOverridesSaveFade: "Guardar fundido",
    animOverridesDuration: "Auto-retorno",
    animOverridesSaveDuration: "Guardar tiempo",
    animOverridesContinuousHint: "Los estados continuos no permiten editar el auto-retorno aquí.",
    animOverridesAssetCycle: "Ciclo de assets",
    animOverridesSuggestedTiming: "Tiempo sugerido",
    animOverridesTimingEstimated: "Estimado",
    animOverridesTimingFallback: "Por defecto del tema",
    animOverridesTimingUnavailable: "No disponible",
    animOverridesDisplayHintWarning: "displayHintMap puede sobrescribir esta ranura en tiempo de ejecución.",
    animOverridesFallbackHint: "Esta ranura cae actualmente en {state}.",
    animOverridesOverriddenTooltip: "Modificado respecto al valor por defecto",
    animOverridesUseOwnFile: "Usar archivo propio",
    animOverridesDurationIdle: "Duración",
    animOverridesSectionIdle: "Idle",
    animOverridesSectionWork: "Trabajo",
    animOverridesSectionInterrupts: "Interrupciones",
    animOverridesSectionSleep: "Sueño",
    animOverridesSectionMini: "Modo Mini",
    animOverridesSectionReactions: "Reacciones",
    animOverridesSectionIdleTracked: "Idle con seguimiento",
    animOverridesSectionIdleAnimated: "Pool aleatorio de idle",
    animOverridesSectionIdleStatic: "Idle estático único",
    animOverridesSectionSleepFull: "Secuencia completa de sueño",
    animOverridesSectionSleepDirect: "Sueño directo",
    animReactionDrag: "Arrastrar (mantener)",
    animReactionClickLeft: "Toque (izquierda)",
    animReactionClickRight: "Toque (derecha)",
    animReactionAnnoyed: "Molesto (toques rápidos)",
    animReactionDouble: "Doble toque",
    animOverridesWideHitboxToggle: "Hitbox ancho",
    animOverridesWideHitboxDesc: "Usa un hitbox más ancho para este frame. Útil cuando el asset sobresale de la silueta por defecto de la mascota.",
    animOverridesWideHitboxResetToTheme: "Restablecer al valor por defecto del tema",
    animOverridesAspectWarning: "Este asset difiere {pct}% en proporción respecto al original. Es posible que tengas que ajustar el hitbox y la posición manualmente.",
    animOverridesExpandRow: "Expandir",
    animOverridesModalTitle: "Elegir archivo de asset",
    animOverridesModalSubtitle: "Añade el archivo a la carpeta assets del tema actual y luego refresca la lista aquí.",
    animOverridesModalEmpty: "Aún no hay assets compatibles para este tema.",
...
function renderGeneralTab(parent) {
  ...
  // Section: Hydration & Translator
  parent.appendChild(buildSection(t("sectionHydrationTranslator"), [
    buildObjectSwitchRow({
      objKey: "waterReminder",
      field: "enabled",
      labelKey: "rowWaterEnabled",
      descKey: "rowWaterEnabledDesc",
    }),
    buildObjectNumberRow({
      objKey: "waterReminder",
      field: "intervalMinutes",
      labelKey: "rowWaterInterval",
      descKey: "rowWaterIntervalDesc",
      min: 1, max: 480, step: 1, suffix: "min",
    }),
    buildObjectQuietHoursRow({
      objKey: "waterReminder",
      labelKey: "rowWaterQuiet",
      descKey: "rowWaterQuietDesc",
    }),
    buildObjectNumberRow({
      objKey: "waterReminder",
      field: "snoozeMinutes",
      labelKey: "rowWaterSnooze",
      descKey: "rowWaterSnoozeDesc",
      min: 1, max: 60, step: 1, suffix: "min",
    }),
    buildWaterTestRow(),
    buildObjectSwitchRow({
      objKey: "translator",
      field: "enabled",
      labelKey: "rowTranslatorEnabled",
      descKey: "rowTranslatorEnabledDesc",
    }),
    buildObjectTextRow({
      objKey: "translator",
      field: "shortcut",
      labelKey: "rowTranslatorShortcut",
      descKey: "rowTranslatorShortcutDesc",
      placeholder: "CmdOrCtrl+Shift+T",
    }),
  ]));
}

// ── Object-field row builders ────────────────────────────────────────────
// These target nested object prefs (waterReminder / translator). Each write
// sends the *full* object back through settings:update — the renderer is the
// single owner of the partial merge.

function readObjectField(objKey, field, fallback) {
  const obj = snapshot && snapshot[objKey];
  if (obj && Object.prototype.hasOwnProperty.call(obj, field)) return obj[field];
  return fallback;
}

function commitObjectPatch(objKey, patch) {
  const current = (snapshot && snapshot[objKey]) || {};
  const next = { ...current, ...patch };
  return window.settingsAPI.update(objKey, next).then((result) => {
    if (!result || result.status !== "ok") {
...
function buildObjectSwitchRow({ objKey, field, labelKey, descKey }) {
  const row = document.createElement("div");
  row.className = "row";
  row.innerHTML =
    `<div class="row-text">` +
  ...
  const sw = row.querySelector(".switch");
  const currentValue = () => !!readObjectField(objKey, field, false);
  setSwitchVisual(sw, currentValue(), { pending: false });
  const run = () => {
    if (sw.classList.contains("pending")) return;
    const next = !currentValue();
    sw.classList.add("pending");
    setSwitchVisual(sw, next, { pending: true });
    commitObjectPatch(objKey, { [field]: next }).finally(() => {
  ...
  sw.addEventListener("keydown", (e) => {
    if (e.key === " " || e.key === "Enter") { e.preventDefault(); run(); }
  });
  return row;
}

function buildObjectNumberRow({ objKey, field, labelKey, descKey, min, max, step, suffix }) {
  const row = document.createElement("div");
  row.className = "row";
  row.innerHTML =
    `<div class="row-text">` +
      ...
      `<span class="row-desc"></span>` +
    `</div>` +
    `<div class="row-control obj-number-control"></div>`;
  row.querySelector(".row-label").textContent = t(labelKey);
  row.querySelector(".row-desc").textContent = t(descKey);
  ...
  input.className = "obj-number-input";
  input.value = String(readObjectField(objKey, field, min));
  control.appendChild(input);
  if (suffix) {
    const s = document.createElement("span");
    s.className = "obj-number-suffix";
    s.textContent = suffix;
    control.appendChild(s);
  }
  const commit = () => {
    let v = Number(input.value);
    if (!Number.isFinite(v)) v = readObjectField(objKey, field, min);
    v = Math.max(min, Math.min(max, Math.round(v)));
    input.value = String(v);
    commitObjectPatch(objKey, { [field]: v });
  };
...
function buildObjectTextRow({ objKey, field, labelKey, descKey, placeholder }) {
  const row = document.createElement("div");
  row.className = "row";
  row.innerHTML =
    `<div class="row-text">` +
  ...
  input.value = String(readObjectField(objKey, field, "") || "");
  row.querySelector(".row-control").appendChild(input);
  const commit = () => {
    const next = input.value.trim();
    const cur = String(readObjectField(objKey, field, "") || "");
    if (next === cur) return;
    commitObjectPatch(objKey, { [field]: next });
  };
  input.addEventListener("change", commit);
  input.addEventListener("blur", commit);
  input.addEventListener("keydown", (e) => { if (e.key === "Enter") { e.preventDefault(); commit(); input.blur(); } });
...
function buildObjectQuietHoursRow({ objKey, labelKey, descKey }) {
  const row = document.createElement("div");
  row.className = "row";
  row.innerHTML =
    `<div class="row-text">` +
      ...
      `<span class="row-desc"></span>` +
    `</div>` +
    `<div class="row-control obj-quiet-control"></div>`;
  row.querySelector(".row-label").textContent = t(labelKey);
  row.querySelector(".row-desc").textContent = t(descKey);
  const control = row.querySelector(".row-control");
  const makeInput = (field) => {
    ...
    inp.type = "time";
    inp.step = "60";
    inp.className = "obj-time-input";
    inp.value = String(readObjectField(objKey, field, "") || "");
    inp.addEventListener("change", () => {
      const raw = inp.value;
      if (!/^([01]\d|2[0-3]):[0-5]\d$/.test(raw)) return;
      commitObjectPatch(objKey, { [field]: raw });
    });
    return inp;
  };
  const startInp = makeInput("quietStart");
  const endInp = makeInput("quietEnd");
  const dash = document.createElement("span");
  dash.className = "obj-dash";
  dash.textContent = "→";
  control.appendChild(startInp);
  control.appendChild(dash);
  control.appendChild(endInp);
  return row;
}

function buildWaterTestRow() {
  const row = document.createElement("div");
  row.className = "row";
  row.innerHTML =
    `<div class="row-text">` +
    ...
    `</div>` +
    `<div class="row-control"></div>`;
  row.querySelector(".row-label").textContent = t("rowWaterTestNow");
  row.querySelector(".row-desc").textContent = t("rowWaterTestNowDesc");
  const btn = document.createElement("button");
  btn.type = "button";
  btn.className = "soft-btn accent";
  btn.textContent = t("actionWaterTriggerNow");
  btn.addEventListener("click", () => {
    if (btn.classList.contains("pending")) return;
    btn.classList.add("pending");
    window.settingsAPI.command("triggerWaterReminder").then((result) => {
      if (!result || result.status !== "ok") {
        const msg = (result && result.message) || "unknown error";
        showToast(t("toastSaveFailed") + msg, { error: true });
      }
    }).finally(() => btn.classList.remove("pending"));
  });
...
function buildLanguageRow() {
  ...
  buttons[2].textContent = t("langSpanish");
